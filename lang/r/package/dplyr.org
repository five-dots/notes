...
* Load library and check version                                        :TOC:
- [[#index][Index]]
- [[#dataset][Dataset]]
...
** Manipulate groups
* Two ~data.frame~ functions                                              :TOC:
** Set Operations
** Join Operations
* Helper functions                                                      :TOC:
** Vector Functions
** Summary Functions
* DB functions                                                          :TOC:
* Imported functions                                                    :TOC:
* Deprecated functions                                                  :TOC:
* Session info                                                          :TOC:
